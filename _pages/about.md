...
profile:
  ...
  address: 
    <p style="font-size:25px;font-family:roboto;color:#cf7da2">Clementine Zimnicki</p>
    <p style="font-size:20px;font-family:roboto;color:#cf7da2">Cognitive Scientist</p>
    <p style="font-size:20px;font-family:roboto;color:#cf7da2">University of Wisconsin-Madison</p>
nav: true
